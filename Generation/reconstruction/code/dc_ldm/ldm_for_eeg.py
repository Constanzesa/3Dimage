...
class eLDM:
    ...
    def __init__(
        ...
        self.config_path = "C:\\Users\\mituser\\Desktop\\3DReconstruction\\imagery2024\\Generation\\reconstruction\\pretrains\\ldm\\label2img\\config.yaml"
        self.ckp_path = "C:\\Users\\mituser\\Desktop\\3DReconstruction\\imagery2024\\Generation\\reconstruction\\pretrains\\ldm\\label2img\\model.ckpt"
        ...
        EEGNet_config_path_01 = "C:\\Users\\mituser\\Desktop\\3DReconstruction\\imagery2024\\Generation\\reconstruction\\pretrains\\EEG\\P001_model_config.yaml"
        ...
        EEGNet_ckpt_path_01 = "C:\\Users\\mituser\\Desktop\\3DReconstruction\\imagery2024\\Generation\\pytorch\\results\\wandb-logs\\lightning_logs\\6jt99ykp\\checkpoints\\best-model-epoch=00-val_acc=0.23.ckpt"
        model.cond_stage_model = cond_stage_model(EEGNet_config_path_01, EEGNet_ckpt_path_01) #Use EEGNet+ as condition stage model
...
def updated_forward(self, x):
    x = self.partial_forward(x) # [1 16 1 15] #bs x F2 x 1 x 15 (128*15) this should be [1 16 1 128]
...
class cond_stage_model(nn.Module):
    def __init__(self, EEGNet_config_path, EEGNet_ckpt_path):
        super().__init__()
        # prepare pretrained EEGNetC:\Users\mituser\Desktop\3DReconstruction\imagery2024\Generation\reconstruction\pretrains\EEG\
        ...
        # EEGNet_ckpt_path = "C:\\Users\\mituser\\Desktop\\3DReconstruction\\imagery2024\\Generation\\reconstruction\\pretrains\\EEG\\best-model-epoch=03-val_acc=0.26.ckpt"
        EEGNet_ckpt_path = "C:\\Users\\mituser\\Desktop\\3DReconstruction\\imagery2024\\Generation\\pytorch\\results\\wandb-logs\\lightning_logs\\6jt99ykp\\checkpoints\\best-model-epoch=00-val_acc=0.23.ckpt"
        ...
        self.channel_mapper = nn.Sequential(
            ...
            nn.Conv1d(77, 10, 1, bias=True) ## CHANGED HERE 
        )

    def forward(self, x):
        latent_crossattn = self.eegnet(x)
        print(f"the shape before the channel mapper is {latent_crossattn.shape} is this ")
