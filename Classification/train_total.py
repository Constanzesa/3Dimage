...
import wandb
import yaml
from data_setup.DataModule_total import DataModule
...
def main(config = None):
    ...
    os.environ['WANDB_API_KEY']= '87c6f217d955521d0ee19f10ec6920c1aa876fef'
    # os.environ['WANDB_NOTEBOOK_NAME']
    # wandb.login()
    wandb.login(key='87c6f217d955521d0ee19f10ec6920c1aa876fef')
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config_path", 
        type=str, 
        default= "C:\\Users\\mituser\\Desktop\\3DReconstruction\\imagery2024\\Generation\\pytorch\\configs\\final\\PTOTAL\\EEGNET_P001.yaml",
