...
parser.add_argument('--project_dir', default='./data/Things-EEG2/', type=str) # '../imagery2024/PREPROCESSED_DATA/2D'
...
# Image directories
img_set_dir = os.path.join(args.project_dir, 'Image_set/image_set') # '2Dimages'
